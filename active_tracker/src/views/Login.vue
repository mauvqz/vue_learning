<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <!-- Login -->
    <!-- .prevent prevents the default action (refresh) from happening -->
    <form @submit.prevent="login" class="p-8 flex flex-col bg-light-gray rounded-md shadow-lg">
    ...
    <button
      type="submit" 
      class="mt-5 py-2 px-6 rounded-sm self-start text-sm
